...
<head>
<meta charset="UTF-8">
<title>Column Mapping Update</title>
...
<div class="flex items-center mb-2">
<label class="flex-1 font-semibold text-left mb-1" >Mapping Table Name</label>
<div class="flex-auto" >
<input type="text" id='mapping_table_name' name= 'mapping_table_name' list="mappingTable">
...
document.getElementById('table_name').addEventListener('change', function () {
    ...
    const datalist = document.getElementById('mappingTable');
